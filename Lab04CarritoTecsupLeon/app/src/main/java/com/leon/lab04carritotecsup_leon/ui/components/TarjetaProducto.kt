...
// Figura 3: Row exterior + Column con weight(1f) + importe + IconButton
// onEliminar: la tarjeta solo AVISA; la pantalla decide qué hacer (elevar eventos)
@Composable
fun TarjetaProducto(producto: Producto, onEliminar: () -> Unit) {
    Card(
        ...
        Row(
            ...
            Text(
                text = formatoSoles(producto.importe),
